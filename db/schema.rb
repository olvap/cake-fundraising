...
ActiveRecord::Schema.define(version: 20140211165604) do
  ...
  create_table "donate_kinds", force: true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  add_index "fundraisers", ["email"], name: "index_fundraisers_on_email", unique: true
  add_index "fundraisers", ["reset_password_token"], name: "index_fundraisers_on_reset_password_token", unique: true
